            ...
            <CardContent className="p-6 flex items-center justify-between">
              <div className="flex items-center gap-4 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <h3 className="text-sm font-bold uppercase truncate text-white leading-none">
            ...
            <CardContent className="p-6 flex items-center justify-between">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-sm font-bold uppercase text-white leading-none">
               ...
               <div className="text-right border-l border-white/5 pl-6 flex flex-col justify-center">
                 <div className="flex items-center justify-end gap-1 mb-1 text-muted-foreground">
