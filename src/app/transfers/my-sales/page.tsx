...
import { ChevronLeft, Loader2, Coins } from 'lucide-react';
  ...
  return (
    <div className="max-w-md mx-auto px-4 pt-8 pb-32">
      <header className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-headline font-bold uppercase tracking-tighter">{language === 'ru' ? 'МОИ ПРОДАЖИ' : 'MY SALES'}</h1>
      ...
      <div className="space-y-3">
        {isMarketLoading ? (
                 ...
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[8px] font-black text-accent uppercase">
                        Highest: {agent.highestBidderName || 'None'}
                      </p>
                    </div>
                 </div>
          ...
          <div className="py-20 text-center opacity-30 text-xs uppercase font-black">No active listings</div>
        )}
      </div>
    </div>
  );
