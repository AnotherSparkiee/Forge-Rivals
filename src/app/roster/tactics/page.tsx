...
export default function TacticsPage() {
  ...
  const t = {
    ...
    presetItems: [
      ...
      { id: 'Side Pressure', label: language === 'ru' ? "Side Pressure" : "Side Pressure", icon: TrendingUp, color: "text-accent", desc: language === 'ru' ? "Активные боковые линии, сдержанный мид." : "Active side lanes, passive mid.", settings: { carry: 'active', mid: 'passive', offlane: 'active' } },
      { id: 'Fast Pace', label: language === 'ru' ? "Fast Pace" : "Fast Pace", icon: Crosshair, color: "text-orange-400", desc: language === 'ru' ? "Активный мид и оффлейн для захвата объектов." : "Active mid and offlane for objective control.", settings: { carry: 'standard', mid: 'active', offlane: 'active' } },
    ]
  };
